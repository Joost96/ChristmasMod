...
public class Config 
{
	    ...
	    public static int configurationProperties()
	    {
	            ...
	            chocoID = Integer.parseInt(configuration.getItem(Configuration.CATEGORY_ITEM, "Chocolate", 5005).value);
	            caneID = Integer.parseInt(configuration.getItem(Configuration.CATEGORY_ITEM, "CandyCane", 5006).value);
	            candyID = Integer.parseInt(configuration.getItem(Configuration.CATEGORY_ITEM, "Candy", 5007).value);
	            doughID = Integer.parseInt(configuration.getItem(Configuration.CATEGORY_ITEM, "Dough", 5008).value);
	            gingerID = Integer.parseInt(configuration.getItem(Configuration.CATEGORY_ITEM, "Gingerbread", 5009).value);
	            smPresID = Integer.parseInt(configuration.getBlock(Configuration.CATEGORY_BLOCK, "PresentS", 155).value);
	            mdPresID = Integer.parseInt(configuration.getBlock(Configuration.CATEGORY_BLOCK, "PresentM", 156).value);
	            lgPresID = Integer.parseInt(configuration.getBlock(Configuration.CATEGORY_BLOCK, "PresentB", 157).value);
	            candleID = Integer.parseInt(configuration.getBlock(Configuration.CATEGORY_BLOCK, "Candle", 161).value);
	            lightID = Integer.parseInt(configuration.getItem(Configuration.CATEGORY_ITEM, "Light", 5000).value);
	            lightsID = Integer.parseInt(configuration.getBlock(Configuration.CATEGORY_BLOCK, "Lights", 151).value);
	            gLightID = Integer.parseInt(configuration.getBlock(Configuration.CATEGORY_BLOCK, "GreenLights", 152).value);
	            bLightID = Integer.parseInt(configuration.getBlock(Configuration.CATEGORY_BLOCK, "BlueLights", 153).value);
	            rLightID = Integer.parseInt(configuration.getBlock(Configuration.CATEGORY_BLOCK, "RedLights", 154).value);
	            bellsID = Integer.parseInt(configuration.getBlock(Configuration.CATEGORY_BLOCK, "Bells", 158).value);
	            stockID = Integer.parseInt(configuration.getBlock(Configuration.CATEGORY_BLOCK, "Stocking", 159).value);
	            wreathID = Integer.parseInt(configuration.getBlock(Configuration.CATEGORY_BLOCK, "Wreath", 160).value);
